...
def generate_config(env: str):
    if env == "prd":
        bucket_name = get_secret('/etl/S3_BUCKET_NAME')
        aws_region = 'us-east-1'
        aws_access_key_id = get_secret('/etl/AWS_ACCESS_KEY_ID')
        aws_secret_access_key = get_secret('/etl/AWS_SECRET_ACCESS_KEY')
...
class S3DataLake:
    def __init__(self):
        self.config = generate_config("prd")
